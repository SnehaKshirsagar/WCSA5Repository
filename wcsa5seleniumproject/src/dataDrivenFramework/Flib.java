...
public class Flib {
        //Flib is use to store generic reusable methods
		...
		public String readExcelData(String excelPath,String sheetName, int rowCount,int cellCount) throws EncryptedDocumentException, IOException
		{
			...
			Row row = sheet.getRow(rowCount);//Create the cell using Row(I)
			Cell cell = row.createCell(cellCount);//Write the data into cell
